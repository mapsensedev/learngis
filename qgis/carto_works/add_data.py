...
/***************************************************************************
 addData
                                 A QGIS plugin
 to add vector and raster data
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
                              -------------------
        begin                : 2020-09-14
        git sha              : $Format:%H$
        copyright            : (C) 2020 by Navjoth
        email                : navjothbn@gmail.com
 ***************************************************************************/
...
class addData:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('addData', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/add_data/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            fileName1 = self.dlg.lineEdit.text()

            layers=[]



            for file in glob.glob(fileName1+"*"): # Change this base path
              uri = file
              lyr=uri[-4:]
              lyr1=uri[-8:]
